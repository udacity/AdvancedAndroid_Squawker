...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    //insert into DB and send a notification on message received from the server
    @Override
    ...
    //Async Task method to insert remote data message takes remote message data as parameter
    ...
    //send notification method with remote data as a parameter
