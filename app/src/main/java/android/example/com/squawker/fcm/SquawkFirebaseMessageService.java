...
public class SquawkFirebaseMessageService extends FirebaseMessagingService {
    ...
    private void insertSquawk(final Map<String, String> data) {
        ...
        AsyncTask<Void, Void, Void> insertSquawkTask = new InsertSquawkTask(this, data);
        insertSquawkTask.execute();
    }

    private static class InsertSquawkTask extends AsyncTask<Void, Void, Void> {

        private Context context;
        private Map<String, String> data;

        public InsertSquawkTask(Context context, Map<String, String> data) {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            context.getContentResolver().insert(SquawkProvider.SquawkMessages.CONTENT_URI, newMessage);
            context = null;
            return null;
        }
    }
